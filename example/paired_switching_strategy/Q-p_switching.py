...
#        return 
 ...
 #### File: p_switching/pswitching.py ###
...
class pswitching(StrategyDesign):
    def __init__(self, context, name = 'pair switching strategy', instruments=None):
        ...
        self.add_schedule_function( schedule_function(self.order_logic,
 ...
 #### File Auto Generated from Zipline: p_switching/context.py ###
